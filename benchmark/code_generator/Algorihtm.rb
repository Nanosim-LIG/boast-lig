...
def ConvolutionGenerator::CallTemplate(conv)
  puts "! #{conv} Conv
           print *,'#{conv} Conv'
           call magicfilter_per_#{conv}(n1,ndat,psi_in,psi_out)
...
$stdout = File.new('MagicFilter.f90', 'w')
$output = $stdout
for i in 1..12 do
  ConvolutionGenerator::MagicFilter(FILTER, 8, i, false)
end

$stdout = File.new('CallTemplate.f90', 'w');
for i in 1..12 do
  ConvolutionGenerator::CallTemplate(i)
end
