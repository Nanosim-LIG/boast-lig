...
__global__ void write_seismograms_transfer_strain_from_device_kernel(int* number_receiver_global,int* ispec_selected_rec,int* ibool,realw* station_strain_field,realw* d_field,int nrec_local) {
