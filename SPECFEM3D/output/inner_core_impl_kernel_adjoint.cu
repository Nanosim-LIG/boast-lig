...
texture<float, cudaTextureType1D, cudaReadModeElementType> d_b_displ_ic_tex;
texture<float, cudaTextureType1D, cudaReadModeElementType> d_b_accel_ic_tex;
#endif
#ifdef USE_TEXTURES_CONSTANTS
texture<float, cudaTextureType1D, cudaReadModeElementType> d_hprime_xx_ic_tex;
texture<float, cudaTextureType1D, cudaReadModeElementType> d_hprimewgll_xx_ic_tex;
#endif
