module BOAST
  require "./SPECFEM3D_compute_element_att_stress_helper.rb"
  ...
  require "./SPECFEM3D_compute_element_gravity_helper.rb"
  ...
  require "./SPECFEM3D_compute_element_att_memory_helper.rb"
