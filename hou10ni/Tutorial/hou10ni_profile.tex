...
\begin{table}[ht!]
\centering
\caption{TODO: Averaged of execution-Time (5 to 10 runs). {\underline{Input parameters}}: elements order=1, Simulation time=..}
{\small
\begin{tabular}{|c|c|c|c|c|c|c|} \hline 
\multirow{2}{*}{ {{\bf{Mesh refinement}}} }	& \multicolumn{3}{c|}{ {{\bf{Time spent in \texttt{sub\_time\_loop}  }}} }	& \multicolumn{3}{c|}{  {{\bf{Total execution time}}} }\\ 
										&   		min & max & avg							& 	min & max & avg			\\ \hline \hline
 		10\ 000		                 				& 29.832	& 31.821 & 								&  	 & 	&  173.77	\\ \hline
 		5\ 000		                 				& 62.568	&  66.309  &	 							&  	 & 	 & 351.35	\\ \hline
 		2\ 500		                 				&  141.110 &  147.306	&							&  	& &  735.548	\\ \hline
\end{tabular}
}
\label{tab:6}
\end{table}
