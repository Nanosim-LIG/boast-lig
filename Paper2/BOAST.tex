...
\markboth{The International Journal of High Performance Computing Applications}
...
For instance \emph{vload16} loads 16 consecutive elements from memory and stores
it in a vector.  Here the loaded vector is of type \emph{uchar16} meaning that it
...
defined can be found in the BigDFT
...
step toward the release of a tunable optimized convolution library oriented toward
...
performed using C macro-functions.
