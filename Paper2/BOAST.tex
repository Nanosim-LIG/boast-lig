...
\FD{BV}{Bizarre la suite ici. Ca fait plus ``previous work''}
...
languages that support \FD{BV}{multi-threading?} threading paradigms (OpenMP). The developer should be
...
\subsection{Non Regression Testing Using Trace Debugging\abel{sec:gputrace}}
