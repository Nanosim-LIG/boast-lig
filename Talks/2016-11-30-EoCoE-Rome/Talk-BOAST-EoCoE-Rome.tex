...
\begin{frame}
\frametitle{Gysela 2d avection - BOAST implementation}
...
\begin{frame}
\frametitle{Gysela 2d avection - BOAST implementation (cont'd)}
...
\begin{frame}
\frametitle{Auto-tuning on INTEL KNL (Xeon Phi 2016)}
\begin{columns}
\column{.3\textwidth}
\scalebox{0.8}{
\begin{minipage}{6cm}
