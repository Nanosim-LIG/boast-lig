...
wave_filter_decompose = WaveletFilterDecompose::new("sym#{L.length/2}", L)
wave_filter_recompose = WaveletFilterRecompose::new("sym#{L.length/2}", L)
n1 = 62
n2 = 66
n3 = 65
...
k1 = Wavelet(wave_filter_decompose, :decompose, optims)
k1.build(:openmp => true)
k2 = Wavelet(wave_filter_recompose, :recompose, optims)
