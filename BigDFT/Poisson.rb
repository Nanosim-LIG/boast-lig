...
subroutine fssnord3dmatnabla3var_lg_ref(geocode,n01,n02,n03,u,du,nord,hgrids)
  implicit none
...
subroutine set_diff_corff (nord, m, c1D)
  integer, intent(in) :: nord, m
...
def fssnord3dmatnabla3var_lg_opt
  ...
  p = BOAST::Procedure::new(function_name, [geocode,n01,n02,n03,u,du,nord,hgrids])
  kernel.code.print <<EOF
subroutine fssnord3dmatnabla3var_lg_opt(geocode,n01,n02,n03,u,du,nord,hgrids)
  implicit none
!  character(len=1), intent(in) :: geocode
  integer, intent(in) :: n01,n02,n03,nord,geocode
  real(kind=8), dimension(3), intent(in) :: hgrids
...
def fssnord3dmatnabla3var_lg_1d
  ...
  nord = BOAST::Int("nord", :dir => :in)
  hgrids = BOAST::Real("hgrids", :dir => :in, :dim => [3] )
  p = BOAST::Procedure::new(function_name, [geocode,n01,n02,n03,u,du,dim,nord,hgrids])

  kernel.code.print <<EOF
subroutine fssnord3dmatnabla3var_lg_1d(geocode,n01,n02,n03,u,du,dim,nord,hgrids)
  implicit none
!  character(len=1), intent(in) :: geocode
  integer, intent(in) :: n01,n02,n03,nord,geocode
  real(kind=8), dimension(3), intent(in) :: hgrids
