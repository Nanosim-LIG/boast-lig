...
three parts, focusing first on tools that provide a DSL to describe computing
kernels. Autotuning frameworks will then be presented. Last, optimization space
