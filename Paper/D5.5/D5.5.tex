...
\change{1.0}{Version to be sent to the EU}
\end{changelog}
...
% \hline
  Image Size  & Naive (s) & Best (s) & Acceleration & BOAST (s) & Acceleration \\[4pt]
  \hline&&&&\\[-8pt]
...
\begin{tabular}{c|r|r|c|r|c}
% \hline
  Image Size & BOAST ARM (s) & BOAST Intel & Ratio & BOAST NVIDIA & Ratio \\[4pt]
  \hline&&&&\\[-8pt]
