...
\author[B. V.]{Anthony~Léonard~\inst{1}, \textbf{Brice~Videau}~\inst{1}, Kevin~Pouget~\inst{1}, Luigi~Genovese~\inst{2},
...
\date{\textbf{Meeting Kalray}\\September 16, 2015}
...
\begin{frame}
\frametitle{BOAST on MPPA}
  \begin{center}
    \includegraphics[scale=0.5]{BOAST_MPPA.pdf}
  \end{center}
\end{frame}

\begin{frame}
\frametitle{BOAST Kernel Execution Workflow on MPPA\vphantom{TODO: Add a DSL to Abstract IO - Compute Transfers}}
  \begin{center}
    \includegraphics[scale=0.5]{BOAST_MPPA_Workflow.pdf}
  \end{center}
\end{frame}

\begin{frame}
\frametitle{TODO: Add a DSL to Abstract IO - Compute Transfers}
  \begin{center}
    \includegraphics[scale=0.5]{BOAST_MPPA_Workflow-TODO.pdf}
  \end{center}
\end{frame}
